...
plt.tight_layout()
plt.savefig('classical_knn_f1_graph.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('classical_svm_f1_graph.png', dpi=300, bbox_inches='tight')
...
print(f"  • Both models show diminishing returns after 8 features")
